...
class UrlService {
  ...
  static const String baseDomain = "kiv.kvalprak.se";
  static const String _defaultSubdomain = "playground"; // Fallback
  ...
  static Future<String> getSelectedClinicSubdomain() async {
    final prefs = await SharedPreferences.getInstance();
    return prefs.getString(_clinicSubdomainKey) ?? _defaultSubdomain;
  }
  ...
  // --- SLUT PÅ KORRIGERADE URL GETTERS ---
}